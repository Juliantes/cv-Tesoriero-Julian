...
const CV = {
  fullName: "Ariel Paredes",
  role: "Desarrollador Full‑Stack (JavaScript/TypeScript)",
  tagline: "Construyo productos web rápidos, mantenibles y centrados en el usuario.",
  location: "La Plata, Buenos Aires (AR) · Remoto/Presencial",
  years: 4,
  github: "https://github.com/arielparedes-dev",
  website: "https://arielparedes.dev",
  email: "ariel.paredes@email.com",
  phone: "+54 11 5555-5555",
  about:
    "Desarrollador con experiencia en apps web, APIs y automatización. Me enfoco en calidad (tests, buenas prácticas), performance y DX. Cómodo trabajando con equipos ágiles y entregas iterativas.",
  top: ["TypeScript", "Node.js", "React", "PostgreSQL", "Docker", "CI/CD"],
  skills: [
    { icon: "code", name: "Frontend", detail: "React · Vite · Accesibilidad · UI" },
    { icon: "code", name: "Backend", detail: "Node · Express · REST · Auth" },
    { icon: "db", name: "Datos", detail: "PostgreSQL · Prisma · Redis" },
    { icon: "cloud", name: "DevOps", detail: "Docker · GitHub Actions · Deploy" },
  ],
  experience: [
    {
      company: "NebulaSoft",
      ...
      bullets: [
        "Desarrollo de dashboard B2B (React + TypeScript) y API (Node).",
        "Mejoras de performance: -35% en tiempo de carga y queries optimizadas.",
        "CI/CD con GitHub Actions y despliegues automatizados.",
      ],
      stack: ["TS", "React", "Node", "PostgreSQL", "Docker"],
    },
    {
      company: "Freelance",
      ...
      period: "2022 — 2024",
      bullets: [
        "Sitios y apps para PyMEs: e‑commerce liviano, reservas y landing pages.",
        "Integraciones con pagos, correo transaccional y analytics.",
      ],
      stack: ["JS", "React", "Node", "SQLite"],
    },
  ],
  projects: [
    {
      name: "TaskFlow",
      description: "Gestor de tareas con etiquetas, búsquedas y modo offline.",
      repo: "https://github.com/arielparedes-dev/taskflow",
      demo: "https://taskflow-demo.example.com",
      tags: ["PWA", "React", "IndexedDB"],
    },
    {
      name: "API Starter",
      description: "Plantilla de API con auth JWT, tests y documentación.",
      repo: "https://github.com/arielparedes-dev/api-starter",
      tags: ["Node", "Express", "Tests"],
    },
  ],
};
